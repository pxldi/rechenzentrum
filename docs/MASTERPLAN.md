...
| Edge/egress expansion | Enforcement proven on the live cluster; method and per-namespace requirements in [EGRESS.md](EGRESS.md). Locked: excalidraw, gotify, obsidian-sync, adventurelog |
